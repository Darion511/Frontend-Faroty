...
export default function ContactSection() {
  return (
    <section className="max-w-7xl mt-10 font-nexa font-light mx-auto px-6 py-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white rounded-xl shadow overflow-hidden">
          <div className="bg-[#8352a5]/30 px-6 py-4  text-[#8352a5]">
            Nos coordonnées
          </div>

          <div className="p-6 space-y-4 text-gray-700">
            <div className="flex items-center gap-3 font-semibold font-nexa ">
        ...
        <div className="bg-white rounded-xl shadow overflow-hidden">
          ...
          <form className="p-6 space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-[#8352a5] text-white py-3 rounded-lg  hover:bg-[#6f4490] transition"
            >
              Envoyer
            </button>
          </form>
