...
export default function Footer() {
  return (
    <footer className="bg-black font-nexa font-light text-white">
      <div className="max-w-7xl mx-auto px-6 py-14 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          <h3 className="text-2xl font-bold mb-4">IFaShop</h3>
      ...
      <div className="border-t border-purple-600">
        <div className="max-w-7xl mx-auto px-6 py-4 text-center text-sm text-purple-200">
          © {new Date().getFullYear()} IFaShop — Tous droits réservés
        </div>
      </div>
    </footer>
  );
